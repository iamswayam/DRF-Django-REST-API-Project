...
class StreamPlatformTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.stream = models.StreamPlatform.objects.create(
            name="Netflix", about="#1 Platform in India", website="https://www.netflix.com")
    ...
    def test_streamplatform_detail_ind(self):
...
class WatchListTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.watchlist = models.WatchList.objects.create(
            platform=self.stream, title="Example", storyline="Example Story", active=True)
